    ...
    if __name__=='__main__':
        while run==1:
            ...
            if "who made you" in statement or "who created you" in statement or "who discovered you" in statement:
                speak("I was built using python by Rahul")
...
def change_name_window():
      ...
      settings_screen.iconbitmap('Radio.ico')
...
def info():
  ...
  info_screen.iconbitmap('Radio.ico')

  creator_label = Label(info_screen,text = "Created by Rahul")
  creator_label.pack()

  Age_label = Label(info_screen, text= " at the age of 19")
  Age_label.pack()

  for_label = Label(info_screen, text = "For bakchodi")
  for_label.pack()
...
def wikipedia_screen(text):
  ...
  wikipedia_screen.iconbitmap('Radio.ico')
...
def main_screen():
      ...
      settings_photo = PhotoImage(file = "gear.png")
